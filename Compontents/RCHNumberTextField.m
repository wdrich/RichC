...
@interface RCHNumberTextField ()<UITextFieldDelegate>{
    BOOL _hasDecimalPoint;
}

@end

@implementation RCHNumberTextField
...
- (void)textFiledDidChange:(UITextField *)textField {
    if (self.onChanged)
    {
        self.onChanged([self p_TrimText:self.text]);
    }
}
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    if (self.finishEdit)
    {
        self.finishEdit(textField.text);
    }
}
