...
- (void)addSubviews
{
    self.backgroundColor = [UIColor clearColor]; //修改蜡烛图信息的背景
...
//        _candleDetailLabel.backgroundColor = [UIColor greenColor];
        _candleDetailLabel.textColor = [UIColor redColor];
        _candleDetailLabel.hidden = NO;
    }
